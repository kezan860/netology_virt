...
root@7d120xqe9n21:/# psql -h localhost -p 5432 -U postgres -W
```
...
root@7d120xqe9n21:/var/lib/postgresql/data# psql -U postgres -f ./pg_backup.sql test_database
...
```
root@7d120xqe9n21:/var/lib/postgresql/data# pg_dump -U postgres -d test_database >test_database_dump.sql
